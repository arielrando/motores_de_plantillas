...
app.get('/productos',(req, res) => {
    (async() => {
        ...
        res.render('products_list',{productList: todos, hayProductos: hayProductos, mensaje: mensaje});
      })();
})

app.get('/agregar',(req, res) => {
    res.render('products_form',{product: false, id: ''});
})
...
app.get('/eliminar/:id',(req, res) => {
    (async() => {
        ...
        if(buscado){
            res.render('products_del',{product: true, id: req.params.id, nombre:buscado.title});
        }else{
            res.render('products_del',{product: false, id: '', nombre:''});
        }
      })();
